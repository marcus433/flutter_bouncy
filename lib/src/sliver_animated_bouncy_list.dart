...
class AnimatedBouncyList extends StatefulWidget {
  ...
  @override
  AnimatedBouncyListState createState() => AnimatedBouncyListState();
}
...
class AnimatedBouncyListState extends State<AnimatedBouncyList>
    with TickerProviderStateMixin<AnimatedBouncyList> {
  final GlobalKey<SliverAnimatedBouncyListState> _sliverAnimatedListKey =
      GlobalKey();
    ...
    return CustomScrollView(
      ...
      slivers: <Widget>[
        SliverPadding(
          ...
          sliver: SliverAnimatedBouncyList(
...
class SliverAnimatedBouncyList extends StatefulWidget {
  ...
  @override
  SliverAnimatedBouncyListState createState() =>
      SliverAnimatedBouncyListState();
...
class SliverAnimatedBouncyListState extends State<SliverAnimatedBouncyList>
